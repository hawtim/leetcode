function getURLFromString(string) {
  ...
  const regexp = new RegExp(
    `${protocol}[${common}?|${separate}]+[${common}|]`,
    'gim'
  )
...
var url =
  'https://www.google.com/search?q=sss&oq=sdsdada12321&aqs=chrome..69i57.7635j0j1&sourceid=chrome&ie=UTF-8'
var url1 =
  'https://www.google.com/search?q=%E+url+%?&oq=%E58F&aqs=chrome.!:,;69i57j33i10i160l2.6963j0j1&sourceid=chrome&ie=UTF-8'
